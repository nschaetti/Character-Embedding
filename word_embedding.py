...
wiki_dataset = datasets.WikipediaWord(context_size=args.context_size, n_gram=args.n_gram)

# Token to ix and voc size
_, voc_size = wiki_dataset.token_to_ix_voc_size()

# Dataset loader
wiki_dataset_loader = DataLoader(wiki_dataset, batch_size=batch_size, shuffle=True, collate_fn=datasets.WikipediaWord.collate)
